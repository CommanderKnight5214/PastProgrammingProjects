...
namespace Memory_Tracker
{
    ...
    {   
        ...
        String[] Question3 = new string[100];
        String[] Question4 = new string[100];
        ...
        private void Clear_Click(object sender, EventArgs e)
        {
            ...
            if (this.Question1TextBox.Text == "" && this.Question2TextBox.Text == "" && this.Question3TextBox.Text == "" &&
                this.Question4TextBox.Text == "" && this.PatientTextBox.Text == "" && this.ListOfMedicationsTextBox.Text == ""
            ...
            else if (this.Question1TextBox.Text != "" || this.Question2TextBox.Text != "" || this.Question3TextBox.Text != "" ||
                this.Question4TextBox.Text != "" || this.PatientTextBox.Text != "" || this.ListOfMedicationsTextBox.Text != ""
                || this.ResponseToMedicationsTextBox.Text != "")
            {
                ...
                Question3[count] = this.Question3TextBox.Text;
                Question4[count] = this.Question4TextBox.Text;
                ...
                this.Question3TextBox.Clear();
                this.Question4TextBox.Clear();
        ...
        private void Undo_Click(object sender, EventArgs e)
        {
            ...
            else if (TargetCount == 1)
            {
                ...
                this.Question3TextBox.Text = Question3[count];
                this.Question4TextBox.Text = Question4[count];
                ...
                Question3[count] = Reset;
                Question4[count] = Reset;
        ...
        private void CompileInformation(String[] InformationCompiled)
        {
            ...
            String Information = TimeStamp + "\n\n" + this.InformationforMedicalDoctorLabel.Text + "\n\n" + this.Question1Label.Text +
                ...
                this.Question3Label.Text + "\n\n" + this.Question3TextBox.Text + "\n\n" + this.Question4Label.Text + "\n\n" +
                this.Question4TextBox.Text + "\n\n" + this.ListOfMedicationsLabel.Text + "\n\n" + this.ListOfMedicationsTextBox.Text +
        ...
        //Text box and labels used, Lines 506-550.
        ...
        private void Question4Label_Click(object sender, EventArgs e)
        {
